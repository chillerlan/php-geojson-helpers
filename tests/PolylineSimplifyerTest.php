<?php
/**
 * Class PolylineSimplifyerTest
 *
 * @link https://github.com/mourner/simplify-js/blob/9c67ff90c058df55267d401efa220d7479134674/test/test.js
 *
 * @created      04.10.2019
...
use chillerlan\GeoJSON\PolylineSimplifyer;
use PHPUnit\Framework\TestCase;

class PolylineSimplifyerTest extends TestCase{
	...
	public function testSimplify():void{
		$poly = new PolylineSimplifyer($this::points);

		$this->assertSame($this::simplified, $poly->simplify(5));
	}
